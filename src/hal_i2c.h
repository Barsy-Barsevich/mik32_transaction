...
inline void hal_i2c_Enable(i2c_t *hi2c) {hi2c->host->CR1 |= I2C_CR1_PE_M;}
inline void hal_i2c_Disable(i2c_t *hi2c) {hi2c->host->CR1 &= ~I2C_CR1_PE_M;}

void hal_i2c_mspinit(i2c_t* hi2c);
